<%-- 
    Document   : ofertarProductos
    Created on : 04-feb-2017, 22:11:01
    Author     : Oscar
--%>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:when test="${pro.oferta=='s'}">
                                                                <td><input type="checkbox" class="ofer" name="ofer" checked="">
                                                                    <input type="hidden" class="idP"  name="idP" value="${pro.idProducto}"></td>
                                                                </c:when>
                                                                <c:otherwise>
                                                                <td><input type="checkbox" class="ofer" name="ofer" >
                                                                    <input type="hidden" class="idP" name="idP" value="${pro.idProducto}"></td>
                                                                </c:otherwise>
                                                            </c:choose>
                                                    </tr>
